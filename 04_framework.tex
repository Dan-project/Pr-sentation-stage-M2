...
%  - Deux LiDAR différents : Velodyne 64 nappes (KITTI, à droite) et
%    Ouster 32 nappes (Scout, à gauche) -> nuage bien plus dense sur KITTI.
% ----------------------------------------------------------------------
\begin{frame}{Association sémantique}
  ...
  \begin{tabular}{@{}c@{\hspace{0.35cm}}c@{}}
    \includegraphics[height=2.85cm]{points.png} &
    \includegraphics[height=2.85cm]{opencv_kitti.png} \\[1pt]
...
%    sur la grande ligne droite, bien plus vite que nos robots).
%  - Transition : la vidéo suivante montre le framework complet en marche.
% ----------------------------------------------------------------------
\begin{frame}{Validation sur KITTI : mise en place}
  \begin{columns}[c]
    ...
    \begin{column}{0.52\textwidth}
      \centering
      \adjincludegraphics[width=\linewidth, trim={{0.02\width} {0.1\height} {0.1\width} {0.08\height}}, clip]{kitti_liosam.png}\\
...
% ----------------------------------------------------------------------
% À DIRE (~20 s)
%  - Vidéo de 10 s sur le bag KITTI : l'affichage OpenCV du framework en
%    temps réel. Masque sémantique YOLO superposé à l'image + points LiDAR
%    projetés (couleur selon la distance), légende des classes à droite.
%  - Montrer que les points tombent bien sur les objets (voitures, route,
%    végétation) -> calibration LiDAR-caméra correcte, association cohérente.
%  - YOLO est bien entraîné pour ce type de scène urbaine (Cityscapes).
%  - Cliquer sur l'image pour lancer la vidéo (pdfpc ou Adobe Reader ;
%    Aperçu sur Mac ne lit pas les vidéos). La vidéo est dans videos/.
% ----------------------------------------------------------------------
\begin{frame}{Validation sur KITTI : fusion en temps réel}
  \centering
  \movie[width=\textwidth, height=0.3016\textwidth, poster, showcontrols, loop]%
    {\includegraphics[width=\textwidth]{videos/opencv_kitti_poster.png}}%
    {videos/opencv_kitti.mp4}\par
  \vspace{0.2cm}
  \legende{Affichage OpenCV : masque YOLO + points LiDAR projetés \quad\textbullet\quad cliquer pour lancer la vidéo (10 s)}
  \vspace{0.3cm}
  {\small points LiDAR bien placés sur les objets $\Rightarrow$ \alert{calibration} et \alert{association} correctes\par}
\end{frame}
